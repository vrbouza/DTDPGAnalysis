...
/* Operations */ 
  ...
  private:
    ...
    edm::EDGetTokenT<DTDigiCollection>theDTLocalDigiToken_;
    edm::EDGetTokenT<DTLocalTriggerCollection>theDTLocalTriggerToken_;
    edm::EDGetTokenT<DTRecSegment4DCollection>theRecHits4DToken_;
    edm::EDGetTokenT<DTRecSegment2DCollection>theRecHits2DToken_;
    edm::EDGetTokenT<DTRecHitCollection>theRecHits1DToken_;
