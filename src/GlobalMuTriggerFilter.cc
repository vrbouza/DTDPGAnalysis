...

{
   ...
   theL1MuonGlobalTriggerToken_ = consumes<L1MuGMTReadoutCollection>(
...
GlobalMuTriggerFilter::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  //iEvent.getByLabel(theL1MuonGlobalTriggerLabel,pCollection); // Doesn't work after 75X
  iEvent.getByToken(theL1MuonGlobalTriggerToken_,pCollection);
