...
## CAMBIO  from RecoMuon.Configuration.RecoMuonCosmics_cff import *
## CAMBIO  esta comentado porque da el error: 'Process' object has no attribute 'GroupedCkfTrajectoryBuilder'
...
## CAMBIO  cosmicMuons.TrajectoryBuilderParameters.EnableRPCMeasurement = False
## CAMBIO  cosmicMuons.TrajectoryBuilderParameters.EnableCSCMeasurement = False
...
## CAMBIO  GlobalTag.globaltag = 'FT_R_70_V1::All'  ## For re-reco con CMSSW_7 
...
## CAMBIO  globalreco = cms.Sequence(CosmicMuonSeed*offlineBeamSpot*cosmicMuons)
